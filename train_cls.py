...
if __name__ == '__main__':
    ...
    # 训练轮次和batch_size
    parser.add_argument('--nepoches', type=int, default=100, help='Number of traing epoches')
    ...
    parser.add_argument('--log_dir', type=str, default=r'F:\deep_learning\PKT_PCQA\kaiyuan\log_pths\test', help='Train/val loss and accuracy logs')  #训练日志路径
